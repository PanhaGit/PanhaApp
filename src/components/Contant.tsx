...
const Contant = () => {
  return (
    <div className="flex justify-center items-center h-screen container bg-gray-100">
      <div className=" hover:bg-black group transition ease-linear cursor-pointer duration-75 delay-75 hover:shadow-emerald-700 md:h-[500px] md:w-[500px] w-[300px] h-[360px] shadow-md rounded-full rounded-b-3xl bg-gray-50">
        <div className="md:h-[300px] md:w-[300px] w-[160px] h-[160px] rounded-full border-8  border-black group-hover:border-8 group-hover:border-white cursor-default md:relative md:-top-10 md:left-24 relative -top-10 left-16 transition-all ease-in delay-75 duration-75">
          <img
            src={Hero}
            alt=""
